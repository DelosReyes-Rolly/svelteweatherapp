			...
			<div style="height: 400px;" class="card-above">
				<LayoutGrid>
					<img
						...
						style="margin: -2.2em; position: absolute; z-index: 1; height:402px; width:1170px; filter: brightness(60%);"
						class="card-above"
					/>
					<Cell
						span={4}
						style="margin: 4em 2em; text-align: center; position: relative; z-index: 2; color: white;"
					>
						<div class="left-to-right">
							...
							<LayoutGrid>
								<Cell span={4} style="letter-spacing: 4px; text-transform: uppercase;">
									Humidity
					...
					<Cell span={4}></Cell>
					<Cell span={4} style="margin: 4em; text-align: center; position: relative; z-index: 2;">
